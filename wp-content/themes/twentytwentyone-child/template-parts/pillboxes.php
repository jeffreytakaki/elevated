...
<div id="pillbox-mobile">
    ...
    <div class="tab-content" id="nav-tabContent">
        <div class="tab-pane fade show active" id="pillbox-mobile-1" role="tabpanel" aria-labelledby="pillbox-mobile-1-tab">hello 0<img src="<?php echo $args['pillbox_image_1']?>" alt=""></div>
        <div class="tab-pane fade show" id="pillbox-mobile-2" role="tabpanel" aria-labelledby="pillbox-mobile-2-tab">hello 1<img src="<?php echo $args['pillbox_image_2']?>" alt=""></div>
        <div class="tab-pane fade show" id="pillbox-mobile-3" role="tabpanel" aria-labelledby="pillbox-mobile-3-tab">hello 2<img src="<?php echo $args['pillbox_image_3']?>" alt=""></div>
        <div class="tab-pane fade show" id="pillbox-mobile-4" role="tabpanel" aria-labelledby="pillbox-mobile-4-tab"><img src="<?php echo $args['pillbox_image_4']?>" alt=""></div>
        <div class="tab-pane fade show" id="pillbox-mobile-5" role="tabpanel" aria-labelledby="pillbox-mobile-5-tab"><img src="<?php echo $args['pillbox_image_5']?>" alt=""></div>
        <div class="tab-pane fade show" id="pillbox-mobile-6" role="tabpanel" aria-labelledby="pillbox-mobile-6-tab"><img src="<?php echo $args['pillbox_image_6']?>" alt=""></div>
    </div>
</div>
